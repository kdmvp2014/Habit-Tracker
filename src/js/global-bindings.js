...
import { applyManualFood, openFoodModal, toggleManualEntry, toggleMicroEntry, deleteFoodItem, searchFood, updateFoodCalc, openBarcodeScanner, stopScanner, saveFood, ernChangeDay } from './nutrition.js';
